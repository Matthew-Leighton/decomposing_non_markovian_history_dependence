...
#Takes in Binarized behaviour time series and returns "word" distributions at various levels of temporal coarse-graining, after shuffling the time-series data.
...
for j in cg_levels:
    ...
    for i in np.arange(1,48):
        if i!=7 and i!= 45:
            ...
            np.savez_compressed('word_distributions_shuffled_fly'+str(i)+'_cg'+str(j)+'.npz', **output)
